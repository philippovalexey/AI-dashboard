...
with col2:
    ...
    expenses_data = pd.DataFrame({
        "Год": [2025, 2026, 2027, 2028],
        "Расходы банка, млн ₽": [450_000, 470_000, 495_000, 520_000],
        "Экономия от ИИ, млн ₽": [800, 1_500, 2_500, 4_000]
    })

    # Расчёт остаточных расходов после ИИ
    expenses_data["Расходы без ИИ, млн ₽"] = expenses_data["Расходы банка, млн ₽"] - expenses_data["Экономия от ИИ, млн ₽"]

    base = alt.Chart(expenses_data).encode(x=alt.X("Год:O", title="Год"))
